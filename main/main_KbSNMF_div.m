...
for gamma = gamma_range
    for theta = theta_range
        ...
        %run algorithm
        [A,S,avg_kurt,smooth_div,obj_fun,C,time] = KbSNMF_div(X,A_init,S_init,tmax,Cmin,gamma,theta);
        ...
        %save variables
        save(sprintf('Variables_KbSNMF_div_samson_gamma_%d_E-2_theta_%d_E-2',gamma_print,theta_print));
